...
- `caption.md` with a substantive post body, hashtags, alt text, and a manual publishing checklist
...
8. Verify the package.
   ...
   - Confirm `caption.md` includes title, a concrete publish-ready body, and hashtags.
